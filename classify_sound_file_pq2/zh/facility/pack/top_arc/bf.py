...
def collectMsg():
    ...
    targets = dumpBfs(str(unpacedkWorkplace), cacheFolder)
...
def rebuildBf():
    ...
    reBuildBfRoot = unpacedkWorkplace
...
cacheFolder = os.path.join(unpacedkWorkplace.parent, unpacedkWorkplace.name + "_cache")
