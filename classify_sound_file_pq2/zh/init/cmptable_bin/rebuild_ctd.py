...
sys.path.append(r'D:\code\git\Persona-Modding\classify_sound_file_pq2\zh\init\cmptable_bin')
...
def rebuildCtd():
    ...
    for targ in targets:
        shutil.copy(os.path.join(rebuildCtdRoot, targ), os.path.join(ctdUnpackedBin, targ))
