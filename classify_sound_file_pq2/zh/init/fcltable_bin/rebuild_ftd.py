...
def rebuildFtd():
    ...
    zhJson = r"D:\code\git\Persona-Modding\classify_sound_file_pq2\zh\init\fcltable_bin\ftd-parts-zh.json"
    jpJson = r"D:\code\git\Persona-Modding\classify_sound_file_pq2\zh\init\fcltable_bin\ftd.json"
